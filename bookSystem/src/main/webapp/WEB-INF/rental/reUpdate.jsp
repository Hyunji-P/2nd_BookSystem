...
<div class="container">
  ...
  <p>대여 수정 페이지입니다.</p>  
  <hr>
   <form method="POST" action="${contextPath}/reUpdate.re" role="form">
  	<div id="rentInput">
  		<input type="hidden" id="reSeq" name="reSeq" value="${bean.reSeq}">
  		<input type="hidden" id="reBookNumber" name="reBookNumber" value="${bean.reBookNumber}">
    	<input type="date"name="reStartDate" id="reStartDate" value="${bean.reStartDate}">
    	&nbsp;&nbsp;
    	<input type="date" name="reEndDate" id="reEndDate" value="${bean.reEndDate}">
