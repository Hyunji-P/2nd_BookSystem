...
<div class="container">
  <h2>도서별 통계 상세 보기</h2>
  <p>도서별 월별 상세 페이지입니다.</p>  
  <hr>         
  <%-- [검색 모드] ==== 시작 ==== --%>
	<form id="contact-form search" method="get" action="${contextPath}/bkMonthDetail.bk" role="form">
		<input id="email" name="bookNumber" value="${requestScope.bookNumber}" type="hidden">
