...
<form action="${contextPath}/bkInsert.bk" method="POST" style="border:1px solid #ccc" enctype="multipart/form-data" >
  ...
  <div class="container">
    ...
    <input type="file" placeholder="Enter Image" id="multiImage" name="multiImage" required value="${bean.bkImage}">
    <span id="err_image" class="errCss"></span><br>
	
	<label for="bkContent"><b>Content</b></label>
	<br>
	<textarea id="bkContent" name="bkContent" placeholder="Enter Content" value="${bean.bkContent}"></textarea>
	<span id="err_content" class="errCss"></span><br>


    <div class="clearfix">
      <button type="reset" class="cancelbtn">Cancel</button>
      <button type="submit" class="signupbtn" onclick="">Insert</button>
    </div>
  </div>
</form>
